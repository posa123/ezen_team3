...
public class AppStart {
	public static void main(String[] args) {
		// 메인 view 실행 
		/*
		 먼저 interfaceSet패키지의 MainInterface에서 추상메소드인 OutPutFront를 선언합니다.
		 ...
		 추가로 입력과 난수생성이 필요한 view클래스는 MainInterface를 구현하는게 아닌 MainInterface를 상속받은 AddRandom , AddScInt , AddScNext 인터페이스를 구현합니다.
		 */
